...
import { fetchPrices, setSelectedRange } from "../../redux/slices/price/PriceRangeSlice";

const PriceRange = () => {
  const dispatch = useDispatch();
  const { minPrice, maxPrice, selectedRange, status } = useSelector((state) => state.priceRange);
