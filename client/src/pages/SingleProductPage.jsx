...
import BestSellProducts from "../components/product/BestSellProducts";
import RelatedProductItems from "../components/product/RelatedProductItems";
...
const SingleProductPage = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await api.get(`/home-appliance-product/${lastSlug}`);
                ...
                <div className="col-span-12 md:col-span-6">
                  <div>
                    ...
                    <h4 className="text-[14px] font-normal mt-5">
                      {product ? `by Madina` : <Skeleton width={150} />}
                    </h4>
